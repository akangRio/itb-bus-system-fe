...
import { getSchedules, bookSchedule } from "../services/schedules";
    ...
    <>
      ...
      <div className="content-center bg-white">
        <div className="space-y-3 p-4 bg-white rounded-xl max-w-md mx-auto">
          {/* Route Selector */}
          <div className="relative bg-[#f5f6fb] flex justify-between items-center rounded-xl px-4 py-3 text-[#2c3e50] font-medium text-base shadow-sm">
            <div>
          ...
          <div className="space-y-1">
            ...
            <button
              ...
              className="w-full flex justify-between items-center bg-[#f5f6fb] rounded-xl px-4 py-3 text-[#2c3e50] font-medium text-base shadow-sm"
            >
              <span>
                {selectedDate
